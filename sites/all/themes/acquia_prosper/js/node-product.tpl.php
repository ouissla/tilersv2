...
<?php } else {?>
	...
	<div id="main-infos">
	    ...
	    <div class="prices">
                ...
                <div class="stock-status">
                    <?php if ($node->stock > 0){ ?>
			<div id="stock-info" class="instock"><div id="stock-info-inner"><h2>Immediate Despatch</h2>We currently hold stock of this item in our warehouse. Purchase this item before 11am and it will be shipped today</div></div>
			<div class="on-stock">Immediate Despatch
		    <?php } else { ?>
			<div id="stock-info" class="offstock"><div id="stock-info-inner"><h2>Available - Possible Delay</h2>We are waiting on delivery of this item from the manufacturer. Add this item to your cart and we will contact you within 24 hours to advise delivery date. You will not be charged for this item</div></div>
                        <div class="off-stock">Available - Possible Delay			
                    <?php } ?>
		    <a href="?width=350&height=150&inline=true#stock-info-inner" class="colorbox-inline"><img src="/sites/all/themes/acquia_prosper/images/question-mark-icon.jpg" /></a>
		    </div>
		</div>
		<br />
		...
		<?php if ($node->field_product_short_description[0]['value'] != '') { ?>
		...
		if ($is_variation){
			...
			$manual_output .= '<p>' . l($manual["filename"], $manual["filepath"]) . '</p>';
		    }
      ...
      <div id="node-bottom" class="node-bottom row nested">
        <div id="node-bottom-inner" class="node-bottom-inner inner">
          <?php //print $node_bottom; ?>
            <?php print theme('display_trp', trp_get_products($node->field_related_products)); ?>
