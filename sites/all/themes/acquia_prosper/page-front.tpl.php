...
<head>
  ...
  <?php print $scripts; ?>
  <script type="text/javascript" src="/sites/all/themes/acquia_prosper/js/acquia-prosper-script.js"></script>
  

  <script type="text/javascript" src="/sites/all/themes/acquia_prosper/js/jcarousel/lib/jquery.jcarousel.js"></script>
  <link href="/sites/all/themes/acquia_prosper/js/jcarousel/skins/tango/skin.css" rel="stylesheet" type="text/css" />
...
jQuery(document).ready(function() {
    ...
    function trigger(carousel, state) {
        $('.jcarousel-nav-links').removeClass('active');
        $('#nav' + carousel.first).addClass('active');
    }; 
      ...
      <?php if ($header_top || $secondary_links || $search_box) { ?>
        <div id="header-top-wrapper" class="header-top-wrapper full-width">
          <div id="header-top" class="<?php if ($search_box): ?>header-top-search<?php endif; ?> header-top row <?php print $grid_width; ?>">
            <div id="header-top-inner" class="megamenu-parent header-top-inner inner clearfix">
              
              <div id="upper-menu">
                <?php print theme('grid_block', theme('links', $secondary_links), 'secondary-menu'); ?>
                <?php print theme('grid_block', $header_top, 'cart-block'); ?>
              </div>
              
              <div id="tilers-mega-menu" class="" style="clear: both;">
                <?php //$menus = _megamenu_enabled_menus(); ?>
                <?php print acquia_prosper_display_menu(); ?>
              </div>
          ...
          <div id="main-inner" class="main-inner inner clearfix">
            ...
            <div id="main-group" class="main-group row nested <?php print $main_group_width; ?>">
              <div id="main-group-inner" class="main-group-inner inner">
                ...
                <?php print tilers_global_show_slider(); ?>
      ...
      <div id="footer-message-wrapper" class="footer-message-wrapper full-width">
        <div id="footer-message" class="footer-message row <?php print $grid_width; ?>">
          <div id="footer-message-inner" class="footer-message-inner inner clearfix">
            ...
            &copy; Copyright Tilers Online 2012
