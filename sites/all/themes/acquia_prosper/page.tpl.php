...
<head>
  ...
  <?php print $scripts; ?>
  <script type="text/javascript" src="/sites/all/libraries/jquery.qtip/jquery.qtip-1.0.0-rc3.min.js"></script>
  <script src="/sites/all/themes/acquia_prosper/js/acquia-prosper-script.js"></script>
