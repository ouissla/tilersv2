...
--------------------------------------------------------------------------------
 ...
 maintained by:
   * Brandon Williams http://drupal.org/user/615672


 original sponsorship by:
...
|  To clone this module into a Drupal site  |
 ...
 [2]$ git clone --branch 6.x-1.x http://git.drupal.org/project/uc_member_pricing.git 
...
|  To import this module as a Git submodule  |
 ...
 [2]$ git submodule add -b 6.x-1.x http://git.drupal.org/project/uc_member_pricing.git
                        sites/all/modules/uc_member_pricing
...
---------------------------------------------
 ...
 [4]$ git checkout -b $MY_BRANCH $MODULE_TAG   
    ...
    # For example, $MY_BRANCH  = 6.x-1.x
    # For example, $MODULE_TAG = 6.x-1.0-beta1
